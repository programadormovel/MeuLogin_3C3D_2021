...
public class MeuLoginActivity extends AppCompatActivity {
    ...
    // um objeto estático exigido pelo Firebase
    private static final String TAG = "MeuLogin3C3D2021";
    // google login
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Firebase Auth - Inicialização do Firebase
        mAuth = FirebaseAuth.getInstance();

        // Objetos da tela - vínculo estabelecido
    ...
    // Método que cria a conta no Firebase
    ...
    // Verifica se usuário e senha existem no Firebase
    ...
    private void trocarJanela(FirebaseUser user) {
        ...
        String nomeUsuario = user.getEmail().toString();
